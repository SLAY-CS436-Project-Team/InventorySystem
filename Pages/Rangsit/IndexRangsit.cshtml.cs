...
namespace InventorySystem.Pages.Rangsit
{
	public class IndexRangsitModel : PageModel
	{
		...
		public void OnGet()
		{
			try
			{
				String connectionString = "Server=tcp:inventorysystem12345.database.windows.net,1433; Initial Catalog = Inventory12345; Persist Security Info = False; User ID = AdminSlay; Password =@AdminSla_y07; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;" ;
